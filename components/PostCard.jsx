    ...
    <div className="bg-white shadow-lg rounded-lg p-0 lg:p-8 pb-12 mb-8">
      ...
      <div className="text-center">
        <Link href={`/post/${post.slug}`}>
          <span className="transition duration-600 transform hover:-translate-y-1 inline-block bg-pink-600 text-white text-lg font-medium rounded-full py-3 px-8 cursor-pointer">
            Continue Reading
          </span>
        </Link>
      </div>
